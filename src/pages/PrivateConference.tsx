    ...
    <div className="min-h-screen bg-[#0a0a0c] flex flex-col relative overflow-hidden">
      ...
      <header className="p-6 flex items-center justify-between z-10">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-lg font-display font-bold uppercase tracking-tighter text-white italic">Conferencia Privada</h1>
        ...
        <div className="hidden sm:flex items-center gap-3 bg-white/5 border border-white/5 px-4 py-2 rounded-xl">
      ...
      <main className="flex-1 p-6 flex flex-col md:flex-row gap-6 z-10">
        <div className="flex-1 relative bg-[#111114] rounded-3xl overflow-hidden border border-white/5 shadow-lg shadow-white/5 shadow-black/[0.04] group">
        ...
        <div className="w-full md:w-[320px] aspect-video md:aspect-[3/4] relative bg-[#111114] rounded-3xl overflow-hidden border border-white/5 shadow-lg shadow-white/5">
      ...
      <footer className="p-8 flex items-center justify-center gap-6 z-10">
        <button
          ...
          className={`w-14 h-14 rounded-xl flex items-center justify-center transition-all border ${
            isMicEnabled 
            ? 'bg-white/5 border-white/10 text-white hover:bg-black/[0.06]' 
        ...
        <button
          onClick={handleLeave}
          className="w-20 h-14 bg-red-500 hover:bg-rose-500 text-white rounded-xl flex items-center justify-center transition-all shadow-[0_0_30px_rgba(239,68,68,0.4)] group active:scale-95"
        >
