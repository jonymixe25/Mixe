...
import { Image as ImageIcon, Trash2, ExternalLink, Calendar, Folder } from 'lucide-react';
...
const Gallery: React.FC = () => {
  ...
  const handleDelete = async (id: string) => {
    if (!window.confirm('¿Estás seguro de que deseas eliminar esta imagen de tu galería?')) return;
    try {
