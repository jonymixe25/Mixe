...
export default async function handler(req: any, res: any) {
  ...
  try {
    ...
    const apiKey = process.env.LIVEKIT_API_KEY || process.env.CLAVE_API_DE_LIVEKIT || 'APIjAwLg2Wy7Th3';
    const apiSecret = process.env.LIVEKIT_API_SECRET || 'ghgayJI7QFRfHVTFBSZ0W5pGEltiaO8nE5Tnk9nHeMX';
    const livekitUrl = process.env.LIVEKIT_URL || 'wss://new-app-6tu2ilh8.livekit.cloud';
